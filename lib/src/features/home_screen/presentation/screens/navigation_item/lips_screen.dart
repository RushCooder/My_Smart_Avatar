...
class LipsScreen extends StatefulWidget {
  const LipsScreen({super.key});

  @override
  State<LipsScreen> createState() => _LipsScreenState();
}

class _LipsScreenState extends State<LipsScreen> {
                          ...
                          children: [
                            if (selectedStyleIndex == 0)
                              Column(
                                ...
                                children: [
                                  Image.asset(
                                      'assets/icons/image_13-removebg-preview 1.png'),
                                  Text('Style')
                                ],
                              ),
